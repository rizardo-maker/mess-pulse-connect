  ...
  const notifications = [
    {
      ...
      date: "2025-05-09",
      content: "There will be a special menu this weekend to celebrate college foundation day.",
      important: true
    },
    {
      id: 2,
      ...
      date: "2025-05-08",
      content: "Please provide your feedback on the new breakfast items introduced this week.",
      link: "/polls",
      important: false
    },
    {
      ...
      date: "2025-05-07",
      content: "Breakfast timings changed to 7:30 AM - 9:00 AM starting next week.",
      important: true
    }
  ];
  ...
  const activePolls = [
    {
      ...
      endDate: "2025-05-15",
      options: ["Idli & Sambar", "Dosa & Chutney", "Puri & Curry", "Upma & Chutney"]
    }
  ];
                ...
                {activePolls.length > 0 ? (
                  activePolls.map(poll => (
                    <div key={poll.id} className="mb-4">
                      ...
                      <p className="text-sm text-gray-500 mb-2">Ends on: {poll.endDate}</p>
